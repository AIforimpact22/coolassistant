...
# =============================================================================
if sv.page == "survey":
    st.title(" ڕاپرسی هەست بە کەش و هەوا 🌡️")
    ...
    # کێشەکان
    st.markdown("#### ٢. کام کێشە کارت تێدەکات؟")
    all_issues = [
        "🔥 گەرما", "🌪️ خۆڵبارین", "💨 با",
        "🏭 پیسبوونی هەوا", "💧 شێداری", "☀️ تیشکی خوَر",
        "⚡ بروسک", "🌧️ باران", "❄️ ساردی", "🌫️ تەم"
    ]
    icol = st.columns(2)
...
*  یارمەتیدەری شاره‌وانیەکان دەبێت بۆ پلانسازی شار  🌳 
*  هاوکاردەبێت بۆ دیزاینکردنی خانوو و بینای گونجاو بۆ هەوا 🏠 
*  یارمەتیدەردەبێت بۆ ئامەدەکاری خزمەتگوزاری تەندروستی پەیوەست بە کەش و هەوا  🩺
*  سەرچاوەی هۆشیاری دەبێت دەربارەی گۆڕانکاری کەش و هەوا و کاریگەری لەسەر کۆچ و ناوچەی نیشتەجێبوون 🧭 
""")
    st.image(
        "https://github.com/AIforimpact22/coolassistant/blob/main/input/cool_logo.png?raw=true",
        width=250,
