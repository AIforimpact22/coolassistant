...
*  یارمەتیدەردەبێت شاره‌وانیەکان شارێکی سارد و تەندروست دیزاین بکەن 🌳 
*  هاوکاردەبێت بۆ دیزاینکردنی ماڵ و بینای گونجاو بۆ هەوا 🏠 
*  ئامەدەکاری خزمەتگوزری تەندروستی پەیوەست بە کەش و هەوا  🩺
*  هۆشیاری دەربارەی گۆڕانکاری کەش و هەوا و کاریگەری لەسەر کۆچ و ناوچەی نیشتەجێبوون 🧭 
""")
    st.image(
        "https://github.com/AIforimpact22/coolassistant/blob/main/input/cool_logo.png?raw=true",
        width=250,
